...
zip_files_paths = [f'gs://projeto-dados-receita-federal/Empresas/{prefix}{i}.zip' for i in range(10)]

# Distribui o processamento dos arquivos ZIP
rdd = spark.sparkContext.parallelize(zip_files_paths)
rdd.foreach(process_zip_file)

logging.info("Unzip dos dados de empresa no storage concluído")
